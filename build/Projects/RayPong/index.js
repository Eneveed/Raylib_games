...
var ASM_CONSTS = {
  107008: () => { if (document.fullscreenElement) return 1; },  
 107054: () => { return Module.canvas.width; },  
 107086: () => { return parseInt(Module.canvas.style.width); },  
 ...
 107280: () => { return Module.canvas.width; },  
 ...
 107676: () => { if (document.fullscreenElement) return 1; },  
 107722: () => { return Module.canvas.width; },  
 ...
 107878: () => { return Module.canvas.width; },  
 107910: () => { return screen.width; },  
 107935: () => { document.exitFullscreen(); },  
 107962: () => { if (document.fullscreenElement) return 1; },  
 108008: () => { return Module.canvas.width; },  
 108040: () => { return parseInt(Module.canvas.style.width); },  
 108088: () => { document.exitFullscreen(); },  
 108115: ($0) => { Module.canvas.style.opacity = $0; },  
 108153: () => { return screen.width; },  
 108178: () => { return screen.height; },  
 108204: () => { return window.screenX; },  
 108231: () => { return window.screenY; },  
 108258: () => { return window.devicePixelRatio; },  
 108294: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 108347: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 108398: () => { Module.canvas.style.cursor = 'none'; },  
 108435: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108691: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 108742: () => { if (document.pointerLockElement) return 1; },  
 108789: () => { if (document.fullscreenElement) return 1; },  
 108835: () => { return window.innerWidth; },  
 108861: () => { return window.innerHeight; }
};
